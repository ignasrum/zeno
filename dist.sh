...
[ -e target/arm-unknown-linux-gnueabihf/release/zeno ] || ./build.sh
...
cp target/arm-unknown-linux-gnueabihf/release/zeno dist/
cp contrib/*.sh dist
...
arm-linux-gnueabihf-strip dist/zeno dist/libs/*
